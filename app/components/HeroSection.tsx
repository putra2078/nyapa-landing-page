...
export default function HeroSection() {
    return (
        <section id="hero" className="relative overflow-hidden pt-16">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 md:py-24 lg:py-32">
                ...
                <div className="flex flex-col items-center text-center gap-6 lg:hidden">
                    ...
                    {/* Hero Text + WhatsApp Icon sejajar */}
                    <div className="flex items-start justify-center w-full max-w-sm mx-auto">
                        ...
                        <div className="w-20 h-20 sm:w-20 sm:h-20 flex-shrink-0 mt-1 -ml-12">
                            <Image
                                src={whatsappIcon}
                                alt="WhatsApp Icon"
                                className="w-full h-auto"
                    ...
                    {/* CTA Button */}
                    <Link href="https://app.nyapa.id/auth/register">
                        <button className="bg-purple-900 w-max px-8 h-12 rounded-full font-bold text-white">
                            Coba Gratis 1 Bulan!
                        </button>
                    </Link>
                </div>
                ...
                <div className="hidden lg:grid grid-cols-2 items-center">
                    ...
                    {/* Left Content */}
                    <div className="text-white space-y-6"></div>
                </div>
            </div>

            {/* Device mockups section */}
            <div className="relative z-20 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 md:mt-0 lg:-mt-12 pb-8 sm:pb-16 md:pb-32">
                <div className="relative w-full flex items-center justify-center">

                    {/* MOBILE: Stack content vertically */}
                    <div className="flex flex-col items-center gap-6 lg:hidden w-full py-8">
                        {/* Text */}
                        <p className="text-white text-lg sm:text-xl font-light leading-snug text-center px-4">
                            Satu aplikasi untuk chat, broadcast,<br />
                            dan <span className="font-bold">kelola pelanggan lebih rapi.</span>
                        </p>
                        ...
                        <Link
                            ...
                            className="bg-[#FF5100] hover:bg-orange-600 text-white px-8 py-3 rounded-full font-bold transition-colors shadow-lg"
                        >
                            Coba Gratis Sekarang!
                        </Link>

                        {/* Device mockups side by side on mobile */}
                        <div className="relative w-full flex justify-between items-end mt-4 px-2">
                    ...
                    <div className="hidden lg:flex relative w-full min-h-[400px] md:min-h-[500px] items-center justify-center">
                        {/* Background Text and Button (Centered) */}
                        <div className="relative z-20 text-center flex flex-col items-center max-w-2xl px-4 pointer-events-auto mt-20 md:mt-0">
                            <p className="text-white text-xl md:text-2xl lg:text-3xl font-light leading-snug mb-8">
                                Satu aplikasi untuk chat, broadcast,<br className="hidden md:block" />
