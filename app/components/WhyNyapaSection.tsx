...
export default function WhyNyapaSection() {
    return (
        <section id="tentang" className="bg-[#341145] py-16 md:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                {/* Section Header */}
                <div className="text-center mb-12 md:mb-16">
                    <div className="flex justify-center">
                        <Image
                            src={whyNyapaHeader}
                            alt="Kenapa bisnismu butuh nyapa?"
                            className="w-full max-w-xs sm:max-w-sm md:w-max h-auto"
                        />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 py-8">
                    ...
                    <div className="bg-white/20 rounded-2xl py-10 md:py-16 px-6 md:px-2 text-center shadow-lg flex flex-col items-center">
                        <div className="flex justify-center w-full">
                            <Image
                                src={chatIcon}
                                alt="Chat message icon"
                                className="w-24 h-24 md:w-full md:h-full mb-6 md:mb-10 mt-2 md:mt-4 object-contain"
                            />
                        </div>
                        <div className="mb-4 mt-6 md:mt-12">
                            ...
                            <p className="text-white text-base md:text-xl font-light">
                                Semua pesan dalam <br /> satu tempat.
                            </p>
                        </div>
                    </div>

                    <div className="bg-white/20 rounded-2xl py-10 md:py-12 px-6 md:px-2 text-center shadow-lg flex flex-col items-center">
                        <div className="flex justify-center">
                            <Image
                                src={targetIcon}
                                alt="Target icon"
                                className="w-24 h-24 md:w-max md:h-max mb-4 object-contain"
                            />
                        </div>
                        <div className="mb-4 mt-6 md:mt-12">
                            <h3 className="text-xl md:text-2xl font-bold text-white mb-3">
                            ...
                            <p className="text-white text-base md:text-xl font-light">
                                Kenali pelanggan lewat <br /> data dan tabel.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/20 rounded-2xl py-10 md:py-12 px-6 md:px-2 text-center shadow-lg flex flex-col items-center">
                        ...
                        <div className="mb-4 mt-6 md:mt-12">
                            ...
                            <p className="text-white text-base md:text-xl font-light">
                                Sapa pelanggan secara <br /> konsisten dan hangat.
                            </p>
                        </div>
                    </div>
